...
from data import load_model, load_open_word_test, target_filter, load_entities
...
def run_tester(single=False, file=None, model_str='transe'):
    if model_str == 'transe':
        ...
        if single:
            ...
            hs, ts, rs = load_open_word_test(device, deep_filtered=True)
